...
local_directory = 'C:/apps/foo/media_root/products_imags'

# Remote server details
remote_server = '157.245.74.156'
remote_user = 'yurey'
remote_directory = '/home/yurey/myprojectdir/media_root/products_imags'
...
seven_days_ago = datetime.now().date() - timedelta(days=3)

all_files = os.listdir(local_directory)
# Filter images created within the last 7 days
recent_images = []
